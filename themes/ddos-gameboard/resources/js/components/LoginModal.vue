          ...
          <form @submit.prevent="handleSubmit(submitForm)" @reset.prevent="reset">
            ...
            <div class="mb-3">
              <validation-provider name="Email address" rules="required|email" v-slot="{ errors }">
                <input v-model="email" name="email" type="text" :class="{'border-red-500' : errors[0]}"
                       class="focus:outline-none focus:shadow-outline" placeholder="Email address">
            ...
            <div class="mb-6">
              <validation-provider name="Password" rules="required" v-slot="{ errors }">
                <input v-model="password" name="password" type="password" :class="{'border-red-500' : errors[0]}"
